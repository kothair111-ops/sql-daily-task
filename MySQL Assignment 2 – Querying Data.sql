...
WHERE Salary > 50000 OR Hire_Date < 2016-01-01 ;
...
SELECT Location.Location,MAX(Employees.Salary) AS Maximum_Salary_by_Location
FROM Employees 
JOIN Location 
ON Employees.Location_Id = Location.Location_Id
GROUP BY Location.Location ;

SELECT Designation, ROUND(AVG(Salary),0) AS Average_Salary 
FROM Employees
WHERE Designation LIKE 	"%Analyst%"
GROUP BY Designation ;

SELECT Departments.Department_Name, COUNT(Employees.Employee_Id) AS Count_of_Employees 
FROM Employees 
JOIN Departments
WHERE Employees.Department_Id = Departments.Department_Id
GROUP BY Departments.Department_Name
HAVING Count_of_Employees <3 ;

SELECT Location.Location, AVG(Employees.Gender) Avg_Age 
FROM Employees 
JOIN Location
...
ON Employees.Department_Id = Departments.Department_Id;
 ...
 -- Left Join:
 SELECT Departments.Department_Name, COUNT(Employees.Employee_Id) Count_Of_Employees
 FROM Employees
...
-- Right Join:
SELECT Employees.Employee_Name, Location.Location
FROM Employees
RIGHT JOIN Location 
ON Employees.Location_Id = Location.Location_Id ;